<div class="w-full col-span-3 flex flex-col justify-evenly items-center">
    <h3 class="text-neutral-500 w-full text-left relative top-8 font-semibold">Expenses</h3>
        <div class="scale-[60%]">
            {!! file_get_contents('expense-chart.svg') !!}
        </div>
    <div class="relative bottom-20 right-2">
        <ul class="text-xxs flex flex-row justify-center space-x-2">
